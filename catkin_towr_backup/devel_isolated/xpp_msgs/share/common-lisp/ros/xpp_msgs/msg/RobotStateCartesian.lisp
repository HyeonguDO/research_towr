...
(cl:defclass <RobotStateCartesian> (roslisp-msg-protocol:ros-message)
  ((time_from_start
   ...
   (ee_tensions_test
    :reader ee_tensions_test
    :initarg :ee_tensions_test
    :type xpp_msgs-msg:State6d
    :initform (cl:make-instance 'xpp_msgs-msg:State6d)))
)
...
(cl:ensure-generic-function 'ee_tensions_test-val :lambda-list '(m))
(cl:defmethod ee_tensions_test-val ((m <RobotStateCartesian>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xpp_msgs-msg:ee_tensions_test-val is deprecated.  Use xpp_msgs-msg:ee_tensions_test instead.")
  (ee_tensions_test m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RobotStateCartesian>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'ee_tensions_test) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RobotStateCartesian>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'ee_tensions_test) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RobotStateCartesian>)))
  ...
  "c88c0f0911b2a034ed67f86381ea2053")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RobotStateCartesian)))
  "Returns md5sum for a message object of type 'RobotStateCartesian"
  "c88c0f0911b2a034ed67f86381ea2053")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RobotStateCartesian>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'ee_tensions_test))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RobotStateCartesian>))
  ...
  (cl:list 'RobotStateCartesian
    ...
    (cl:cons ':ee_tensions_test (ee_tensions_test msg))
))
