...
class RobotStateCartesian {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('ee_tensions_test')) {
        this.ee_tensions_test = initObj.ee_tensions_test
      }
      else {
        this.ee_tensions_test = new State6d();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [ee_tensions_test]
    bufferOffset = State6d.serialize(obj.ee_tensions_test, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [ee_tensions_test]
    data.ee_tensions_test = State6d.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return 'c88c0f0911b2a034ed67f86381ea2053';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.ee_tensions_test !== undefined) {
      resolved.ee_tensions_test = State6d.Resolve(msg.ee_tensions_test)
    }
    else {
      resolved.ee_tensions_test = new State6d()
    }
