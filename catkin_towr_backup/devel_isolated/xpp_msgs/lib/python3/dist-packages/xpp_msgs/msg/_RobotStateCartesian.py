...
class RobotStateCartesian(genpy.Message):
  _md5sum = "c88c0f0911b2a034ed67f86381ea2053"
...
geometry_msgs/Vector3 acc"""
  __slots__ = ['time_from_start','base','ee_motion','ee_forces','ee_contact','ee_tensions_test']
  _slot_types = ['duration','xpp_msgs/State6d','xpp_msgs/StateLin3d[]','geometry_msgs/Vector3[]','bool[]','xpp_msgs/State6d']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       time_from_start,base,ee_motion,ee_forces,ee_contact,ee_tensions_test
    ...
    if args or kwds:
      ...
      if self.ee_contact is None:
        self.ee_contact = []
      if self.ee_tensions_test is None:
        self.ee_tensions_test = xpp_msgs.msg.State6d()
    else:
      self.time_from_start = genpy.Duration()
      self.base = xpp_msgs.msg.State6d()
      self.ee_motion = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_19d().pack(_x.ee_tensions_test.pose.position.x, _x.ee_tensions_test.pose.position.y, _x.ee_tensions_test.pose.position.z, _x.ee_tensions_test.pose.orientation.x, _x.ee_tensions_test.pose.orientation.y, _x.ee_tensions_test.pose.orientation.z, _x.ee_tensions_test.pose.orientation.w, _x.ee_tensions_test.twist.linear.x, _x.ee_tensions_test.twist.linear.y, _x.ee_tensions_test.twist.linear.z, _x.ee_tensions_test.twist.angular.x, _x.ee_tensions_test.twist.angular.y, _x.ee_tensions_test.twist.angular.z, _x.ee_tensions_test.accel.linear.x, _x.ee_tensions_test.accel.linear.y, _x.ee_tensions_test.accel.linear.z, _x.ee_tensions_test.accel.angular.x, _x.ee_tensions_test.accel.angular.y, _x.ee_tensions_test.accel.angular.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ee_tensions_test.pose.position.x, _x.ee_tensions_test.pose.position.y, _x.ee_tensions_test.pose.position.z, _x.ee_tensions_test.pose.orientation.x, _x.ee_tensions_test.pose.orientation.y, _x.ee_tensions_test.pose.orientation.z, _x.ee_tensions_test.pose.orientation.w, _x.ee_tensions_test.twist.linear.x, _x.ee_tensions_test.twist.linear.y, _x.ee_tensions_test.twist.linear.z, _x.ee_tensions_test.twist.angular.x, _x.ee_tensions_test.twist.angular.y, _x.ee_tensions_test.twist.angular.z, _x.ee_tensions_test.accel.linear.x, _x.ee_tensions_test.accel.linear.y, _x.ee_tensions_test.accel.linear.z, _x.ee_tensions_test.accel.angular.x, _x.ee_tensions_test.accel.angular.y, _x.ee_tensions_test.accel.angular.z,) = _get_struct_19d().unpack(str[start:end])
