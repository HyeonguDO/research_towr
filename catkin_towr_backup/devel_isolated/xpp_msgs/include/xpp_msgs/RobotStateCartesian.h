...
struct RobotStateCartesian_
{
  ...
  _base_type base;
   ...
   typedef std::vector< ::xpp_msgs::StateLin3d_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::xpp_msgs::StateLin3d_<ContainerAllocator> >> _ee_motion_type;
  _ee_motion_type ee_motion;

   typedef std::vector< ::geometry_msgs::Vector3_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::geometry_msgs::Vector3_<ContainerAllocator> >> _ee_forces_type;
  _ee_forces_type ee_forces;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _ee_contact_type;
  _ee_contact_type ee_contact;

   typedef  ::xpp_msgs::State6d_<ContainerAllocator>  _ee_tensions_test_type;
  _ee_tensions_test_type ee_tensions_test;
...
bool operator==(const ::xpp_msgs::RobotStateCartesian_<ContainerAllocator1> & lhs, const ::xpp_msgs::RobotStateCartesian_<ContainerAllocator2> & rhs)
{
  return lhs.time_from_start == rhs.time_from_start &&
    ...
    lhs.ee_tensions_test == rhs.ee_tensions_test;
}
...
struct MD5Sum< ::xpp_msgs::RobotStateCartesian_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xc88c0f0911b2a034ULL;
  static const uint64_t static_value2 = 0xed67f86381ea2053ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::xpp_msgs::RobotStateCartesian_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.ee_tensions_test);
    }
...
struct Printer< ::xpp_msgs::RobotStateCartesian_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::xpp_msgs::RobotStateCartesian_<ContainerAllocator>& v)
  {
    ...
    s << indent << "ee_tensions_test: ";
    s << std::endl;
    Printer< ::xpp_msgs::State6d_<ContainerAllocator> >::stream(s, indent + "  ", v.ee_tensions_test);
  }
};
