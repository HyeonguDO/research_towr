#ifndef TOWR_PITCH_COSTS_NODE_COST_H_
#define TOWR_PITCH_COSTS_NODE_COST_H_
 ...
 * @ingroup Costs
 */
class PitchNodeCost : public ifopt::CostTerm {
public:
  /**
   ...
   */
  PitchNodeCost (const std::string& nodes_id, Dx deriv, int dim, double weight);
  virtual ~PitchNodeCost () = default;
